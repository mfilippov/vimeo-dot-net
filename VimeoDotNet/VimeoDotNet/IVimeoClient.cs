...
namespace VimeoDotNet
{
    public interface IVimeoClient
    {
        ...
        VimeoDotNet.Models.Paginated<VimeoDotNet.Models.Video> GetUserVideos(string userId);
        System.Threading.Tasks.Task<VimeoDotNet.Models.Paginated<VimeoDotNet.Models.Video>> GetUserVideosAsync(string userId);
